...
class CausalSelfAttention(nn.Module):
    ...
    def __init__(self, config):
        ...
        # flash attention to boost the GPU speed (supported for Pytorch>=2.0)
    ...
    def forward(self, x):
        ...
        # causal self-attention; Self-attend: (B,nh,T,ns) x (B,nh,ns,T) -> (B,nh,T,T)
...
class GPT(nn.Module):
    ...
    def get_num_params(self, non_embedding=True):
        """
        Return the number of parameters in teh model.
        For non-embedding count, the position embeddings get subtracted.
        The token embedding would too, except due to the parameter sharing these
